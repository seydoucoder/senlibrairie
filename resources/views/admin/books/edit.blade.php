                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="prix" id="prix" value="{{ old('prix', $book->prix) }}" required min="0"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            @error('prix')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" name="quantite" id="quantite" value="{{ old('quantite', $book->quantite) }}" required min="0"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            @error('quantite')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div>
                        ...
                        <img src="{{ asset($book->image) }}" alt="{{ $book->titre }}" class="mt-2 h-32 w-32 object-cover rounded">
                    </div>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="est_populaire" id="est_populaire"
                            {{ $book->est_populaire ? 'checked' : '' }}
